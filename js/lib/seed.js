...
export const SEED = {
  ...
  items: [
    ...
    { code: 'P-MCT-01', name: 'MCT 하우징 가공품', item_type: '완제품', customer: 'DOOWON', customer_part_no: 'DW-MCT-01', car_model: 'NE', defect_photos: '[{"url": "data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22120%22 height=%22120%22%3E%3Crect width=%22120%22 height=%22120%22 fill=%22%23fde2e2%22/%3E%3Ccircle cx=%2260%22 cy=%2260%22 r=%2226%22 fill=%22none%22 stroke=%22%23c0392b%22 stroke-width=%225%22/%3E%3C/svg%3E", "note": "내경 스크래치"}, {"url": "data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22120%22 height=%22120%22%3E%3Crect width=%22120%22 height=%22120%22 fill=%22%23fef3c7%22/%3E%3Cpath d=%22M30 80 L60 35 L90 80 Z%22 fill=%22none%22 stroke=%22%23b45309%22 stroke-width=%225%22/%3E%3C/svg%3E", "note": "전장 미달"}, {"url": "data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22120%22 height=%22120%22%3E%3Crect width=%22120%22 height=%22120%22 fill=%22%23e0e7ff%22/%3E%3Crect x=%2238%22 y=%2238%22 width=%2244%22 height=%2244%22 fill=%22none%22 stroke=%22%233b63f0%22 stroke-width=%225%22/%3E%3C/svg%3E", "note": "BURR 발생"}]', spec: '120x80x45', unit: 'EA', unit2: 'KG', unit_weight: 0.62, material: 'AL 6061-T6', drawing_no: 'DWG-MCT01-A', routing_group: 'RG-MCT', category: '가공', safety_stock: 300, sale_price: 8500, purchase_price: 0, subcon_price: 1200, unit_price: 8500, location: '제품창고 B-01', partner: 'DOOWON', use_yn: true },
    { code: 'P-CNC-01', name: 'CNC 브라켓 가공품', item_type: '완제품', customer: '현대모비스', customer_part_no: 'HM-BRK-01', car_model: 'SU2', spec: 'Ø95 H40', unit: 'EA', unit2: 'KG', unit_weight: 0.48, material: 'AL 6063-T5', drawing_no: 'DWG-CNC01-A', routing_group: 'RG-CNC', category: '가공', safety_stock: 250, sale_price: 6800, purchase_price: 0, subcon_price: 900, unit_price: 6800, location: '제품창고 B-02', partner: '현대모비스', use_yn: true },
    { code: 'P-PIPE-01', name: 'COOLING PIPE', item_type: '완제품', customer: 'PYONGSAN', customer_part_no: 'PS-CP-01', car_model: 'MX5', spec: 'Ø12 L850 벤딩', unit: 'EA', unit2: 'KG', unit_weight: 0.35, material: 'AL 5052-H32', drawing_no: 'DWG-PIPE01-B', routing_group: 'RG-PIPE', category: '성형', safety_stock: 400, sale_price: 4200, purchase_price: 0, subcon_price: 0, unit_price: 4200, location: '제품창고 C-01', partner: 'PYONGSAN', use_yn: true },
  ...
  sales_orders: [
    { order_no: 'SO-2607-001', order_date: d(-5), partner: 'DOOWON', item_code: 'P-MCT-01', item_name: 'MCT 하우징 가공품', spec: '120x80x45', unit: 'EA', order_qty: 500, order_weight: 310, unit_price: 8500, amount: 4250000, due_date: d(10), po_no: 'DW-PO-1121', urgent_yn: true, ship_to: '두원공조 창원공장', status: '생산중' },
    ...
    { order_no: 'SO-2607-003', order_date: d(-1), partner: '삼성SDI', item_code: 'P-SP2-PE', item_name: 'SP2 PE ASSY', spec: 'SP2-PE Rev.C', unit: 'EA', order_qty: 300, order_weight: 255, unit_price: 18500, amount: 5550000, due_date: d(20), po_no: 'SDI-PO-8871', ship_to: '삼성SDI 천안', status: '접수' },
  ...
  four_m_changes: [
    { fm_no: '4M-2607-001', change_date: d(-5), category: 'Machine', grade: '중요4M', source: '사전신청', item_code: 'P-MCT-01', item_name: 'MCT 하우징 가공품', process: 'MCT가공', before_desc: 'MCT-01 1호기 단독 가공', after_desc: 'MCT-02 2호기 병행 가공 추가', reason: '수주량 증가 대응', risk_review: '동일 사양 설비 · 치수 변동 위험 낮음, 초도품 검증으로 확인', initial_sample: '초도품 5EA 전수검사 합격 (Cpk 1.52)', focus_inspect: '변경 후 100EA 전수검사 이상 없음', customer_notify_yn: true, customer_approval_yn: true, customer_approval_url: 'https://example.com/approve/mct-02', ppap_yn: true, doc_pfd_yn: true, doc_pfmea_yn: true, doc_cp_yn: true, approver: '관리자', approve_date: d(-3), status: '승인', apply_status: '완료', apply_date: d(-2), apply_lot: 'LOT-WO-2607-001' },
    { fm_no: '4M-2607-002', change_date: d(-2), category: 'Man', grade: '단순이력', source: '사전신청', item_code: 'P-MCT-01', item_name: 'MCT 하우징 가공품', process: 'MCT가공', before_desc: '용접작업자 김작업', after_desc: '용접작업자 이작업 (용접자격 보유 확인)', reason: '작업조 교대', initial_sample: '자격 확인 완료', status: '승인', approver: '관리자', approve_date: d(-2), apply_status: '완료' },
  ],
  ppap_approvals: [
    { ppap_no: 'PPAP-2607-001', submit_date: d(-3), customer: 'DOOWON', car_project: 'NE 프로젝트', item_code: 'P-MCT-01', item_name: 'MCT 하우징 가공품', part_no: 'DW-MCT-01', level: 'Level 3', reason: '4M변경', fm_no: '4M-2607-001', docs: 'PSW, 치수측정결과, Cpk, MSA, 관리계획서', chk_pfd: true, chk_pfmea: true, chk_cp: true, chk_ws: true, chk_drawing: true, chk_result: true, chk_capability: true, chk_msa: true, chk_psw: true, approver: '', status: '제출' },
    { ppap_no: 'PPAP-2606-001', submit_date: d(-40), customer: '현대모비스', car_project: 'SU2', item_code: 'P-CNC-01', item_name: 'CNC 브라켓 가공품', part_no: 'HM-BRK-01', level: 'Level 3', reason: '신규부품', docs: 'PSW, 치수측정결과, 재질성적서, Cpk, MSA, 외관한도견본', chk_pfd: true, chk_pfmea: true, chk_cp: true, chk_ws: true, chk_drawing: true, chk_result: true, chk_material: true, chk_capability: true, chk_msa: true, chk_appearance: true, chk_sample: true, chk_psw: true, chk_customer: true, approver: '김승인', approve_date: d(-34), apply_date: d(-33), status: '승인' },
  ],
  dev_docs: [
    ...
    { doc_no: 'DOC-2607-005', doc_type: '작업표준서', customer: 'DOOWON', part_no: 'DW-MCT-01', item_code: 'P-MCT-01', item_name: 'MCT 하우징 가공품', process: 'MCT가공', rev: 'A', title: 'MCT 하우징 가공 작업표준서', writer: '박생산', write_date: d(-26), approver: '관리자', approve_date: d(-22), status: '승인' },
    // CNC 브라켓 — 4문서 전체 승인 완료(정합성 OK 사례)
    { doc_no: 'DOC-2607-006', doc_type: 'PFD', customer: '현대모비스', part_no: 'HM-BRK-01', item_code: 'P-CNC-01', item_name: 'CNC 브라켓 가공품', process: '', rev: 'B', title: 'CNC 브라켓 공정흐름도', writer: '최품질', write_date: d(-45), approver: '관리자', approve_date: d(-40), status: '승인' },
    { doc_no: 'DOC-2607-007', doc_type: 'PFMEA', customer: '현대모비스', part_no: 'HM-BRK-01', item_code: 'P-CNC-01', item_name: 'CNC 브라켓 가공품', process: '', rev: 'B', title: 'CNC 브라켓 공정 PFMEA', writer: '최품질', write_date: d(-43), approver: '관리자', approve_date: d(-38), status: '승인' },
    { doc_no: 'DOC-2607-008', doc_type: '관리계획서', customer: '현대모비스', part_no: 'HM-BRK-01', item_code: 'P-CNC-01', item_name: 'CNC 브라켓 가공품', process: '', rev: 'B', title: 'CNC 브라켓 관리계획서', writer: '최품질', write_date: d(-41), approver: '관리자', approve_date: d(-36), status: '승인' },
    { doc_no: 'DOC-2607-009', doc_type: '작업표준서', customer: '현대모비스', part_no: 'HM-BRK-01', item_code: 'P-CNC-01', item_name: 'CNC 브라켓 가공품', process: '', rev: 'B', title: 'CNC 브라켓 가공 작업표준서(전공정)', writer: '박생산', write_date: d(-39), approver: '관리자', approve_date: d(-34), status: '승인' },
    // COOLING PIPE — PFD·PFMEA·관리계획서 승인, 작업표준서 작성중(진행 사례)
    { doc_no: 'DOC-2607-010', doc_type: 'PFD', customer: 'PYONGSAN', part_no: 'PS-CP-01', item_code: 'P-PIPE-01', item_name: 'COOLING PIPE', process: '', rev: 'A', title: 'COOLING PIPE 공정흐름도', writer: '최품질', write_date: d(-28), approver: '관리자', approve_date: d(-24), status: '승인' },
    { doc_no: 'DOC-2607-011', doc_type: 'PFMEA', customer: 'PYONGSAN', part_no: 'PS-CP-01', item_code: 'P-PIPE-01', item_name: 'COOLING PIPE', process: '', rev: 'A', title: 'COOLING PIPE 공정 PFMEA', writer: '최품질', write_date: d(-26), approver: '관리자', approve_date: d(-22), status: '승인' },
    { doc_no: 'DOC-2607-012', doc_type: '관리계획서', customer: 'PYONGSAN', part_no: 'PS-CP-01', item_code: 'P-PIPE-01', item_name: 'COOLING PIPE', process: '', rev: 'A', title: 'COOLING PIPE 관리계획서', writer: '최품질', write_date: d(-25), approver: '관리자', approve_date: d(-21), status: '승인' },
  ],
  ...
  pfd_items: [
    { doc_no: 'DOC-2607-002', seq: 10, process_no: '10', process_code: 'OP10', process_name: 'MCT가공', process_type: '가공', equipment: 'MCT-01', input_item: 'AL6061 환봉 Ø130', output_item: 'MCT 하우징 반제품', material_flow: '자재창고 → MCT라인 대차', char_type: '특별특성', inspect_yn: false },
    { doc_no: 'DOC-2607-002', seq: 20, process_no: '20', process_code: 'OP70', process_name: '외주 열처리', process_type: '외주', equipment: '', input_item: 'MCT 하우징 반제품', output_item: '열처리품', material_flow: '외주출고장 → 협력사', outsource_yn: true, partner: '한국열처리', inspect_yn: false },
    { doc_no: 'DOC-2607-002', seq: 30, process_no: '30', process_code: 'OP20', process_name: 'CNC가공', process_type: '가공', equipment: 'CNC-01', input_item: '열처리품', output_item: 'MCT 하우징 가공품', material_flow: '외주입고검사 → CNC라인', char_type: '중요특성', inspect_yn: false },
    { doc_no: 'DOC-2607-002', seq: 40, process_no: '40', process_code: 'OP90', process_name: '검사', process_type: '검사', equipment: 'CMM-01', input_item: 'MCT 하우징 가공품', output_item: '합격품', material_flow: 'CNC라인 → 검사장', inspect_yn: true },
    { doc_no: 'DOC-2607-002', seq: 50, process_no: '50', process_code: 'OP99', process_name: '포장·보관', process_type: '보관', equipment: '', input_item: '합격품', output_item: '출하대기품', material_flow: '검사장 → 제품창고', storage_yn: true, inspect_yn: false },
    // CNC 브라켓 (DOC-2607-006)
    { doc_no: 'DOC-2607-006', seq: 10, process_no: '10', process_code: 'OP20', process_name: 'CNC가공', process_type: '가공', equipment: 'CNC-01', input_item: 'AL6063 압출바', output_item: 'CNC 브라켓 반제품', material_flow: '자재창고 → CNC라인', char_type: '특별특성', inspect_yn: false },
    { doc_no: 'DOC-2607-006', seq: 20, process_no: '20', process_code: 'OP30', process_name: 'DRILL', process_type: '가공', equipment: 'DRL-01', input_item: 'CNC 브라켓 반제품', output_item: '홀가공품', material_flow: 'CNC라인 → DRILL라인', char_type: '중요특성', inspect_yn: false },
    { doc_no: 'DOC-2607-006', seq: 30, process_no: '30', process_code: 'OP80', process_name: '외주 표면처리', process_type: '외주', equipment: '', input_item: '홀가공품', output_item: '아노다이징 처리품', material_flow: '외주출고장 → 협력사', outsource_yn: true, partner: '아노다이징텍', inspect_yn: false },
    { doc_no: 'DOC-2607-006', seq: 40, process_no: '40', process_code: 'OP90', process_name: '검사', process_type: '검사', equipment: 'CMM-01', input_item: '아노다이징 처리품', output_item: '합격품', material_flow: '외주입고검사 → 검사장', inspect_yn: true },
    { doc_no: 'DOC-2607-006', seq: 50, process_no: '50', process_code: 'OP99', process_name: '포장', process_type: '포장', equipment: '', input_item: '합격품', output_item: '출하대기품', material_flow: '검사장 → 제품창고 B-02', storage_yn: true, inspect_yn: false },
    // COOLING PIPE (DOC-2607-010)
    { doc_no: 'DOC-2607-010', seq: 10, process_no: '10', process_code: 'OP40', process_name: 'PIPE성형', process_type: '가공', equipment: 'PIPE-01', input_item: 'AL5052 파이프 Ø12', output_item: '벤딩 성형품', material_flow: '자재창고 → 성형라인', char_type: '특별특성', inspect_yn: false },
    { doc_no: 'DOC-2607-010', seq: 20, process_no: '20', process_code: 'OP50', process_name: '용접', process_type: '가공', equipment: 'WELD-01', input_item: '벤딩 성형품', output_item: '용접 조립품', material_flow: '성형라인 → 용접라인', char_type: '중요특성', inspect_yn: false },
    { doc_no: 'DOC-2607-010', seq: 30, process_no: '30', process_code: 'OP90', process_name: '검사', process_type: '검사', equipment: 'CMM-01', input_item: '용접 조립품', output_item: '합격품', material_flow: '용접라인 → 검사장', char_type: '중요특성', inspect_yn: true },
    { doc_no: 'DOC-2607-010', seq: 40, process_no: '40', process_code: 'OP99', process_name: '포장', process_type: '포장', equipment: '', input_item: '합격품', output_item: '출하대기품', material_flow: '검사장 → 제품창고 C-01', storage_yn: true, inspect_yn: false },
  ],
  pfmea_items: [
    { doc_no: 'DOC-2607-001', seq: 10, process_no: '10', process_name: 'MCT가공', process: 'MCT가공', func: '내경 Ø25 가공', fail_mode: '내경 치수 초과', fail_effect: '조립 불가 (고객 라인 정지)', severity: 8, fail_cause: '공구 마모', occurrence: 5, prevent_ctrl: '공구 교체알람 450회 설정', detect_ctrl: '초·중·종물 3차원측정', detection: 3, rpn: 120, char_type: '특별특성', cp_reflected: true, action_plan: '교체 후 치수검증 의무화', action_owner: '박생산', after_sev: 8, after_occ: 2, after_det: 3, after_rpn: 48 },
    { doc_no: 'DOC-2607-001', seq: 20, process_no: '10', process_name: 'MCT가공', process: 'MCT가공', func: '전장 120 가공', fail_mode: '전장 미달', fail_effect: '조립 간섭', severity: 6, fail_cause: '셋업 오류', occurrence: 3, prevent_ctrl: '작업표준서 셋업 체크리스트', detect_ctrl: '초물검사', detection: 3, rpn: 54, char_type: '중요특성', cp_reflected: true },
    { doc_no: 'DOC-2607-001', seq: 30, process_no: '30', process_name: 'CNC가공', process: 'CNC가공', func: '외경 마무리', fail_mode: '표면 거칠기 불량', fail_effect: '외관 불량', severity: 4, fail_cause: '이송속도 과다', occurrence: 3, prevent_ctrl: '가공조건 표준화', detect_ctrl: '육안검사', detection: 4, rpn: 48, char_type: '일반', cp_reflected: true },
    { doc_no: 'DOC-2607-001', seq: 40, process_no: '40', process_name: '검사', process: '검사', func: '최종 치수·외관 확인', fail_mode: '부적합품 유출', fail_effect: '고객 클레임 / 라인 정지', severity: 9, fail_cause: '검사항목 누락', occurrence: 3, prevent_ctrl: '검사규격 체크시트 운영', detect_ctrl: '전수 외관검사', detection: 4, rpn: 108, char_type: '중요특성', cp_reflected: false, action_plan: '관리계획서 검사항목 반영 예정', action_owner: '최품질' },
    // CNC 브라켓 (DOC-2607-007) — PFD 5개 공정 전체 분석
    { doc_no: 'DOC-2607-007', seq: 10, process_no: '10', process_name: 'CNC가공', process: 'CNC가공', func: '외경 Ø95 가공', fail_mode: '외경 치수 초과', fail_effect: '조립 시 압입 불가', severity: 8, fail_cause: '인서트 마모', occurrence: 3, prevent_ctrl: '인서트 교체주기 300개 관리', detect_ctrl: '초·중·종물 마이크로미터 측정', detection: 3, rpn: 72, char_type: '특별특성', cp_reflected: true },
    { doc_no: 'DOC-2607-007', seq: 20, process_no: '20', process_name: 'DRILL', process: 'DRILL', func: '홀 Ø8 4개소 가공', fail_mode: '홀 위치도 이탈', fail_effect: '체결 볼트 간섭', severity: 6, fail_cause: '지그 클램프 유격', occurrence: 3, prevent_ctrl: '지그 일상점검 체크시트', detect_ctrl: '초·중·종물 3차원측정', detection: 3, rpn: 54, char_type: '중요특성', cp_reflected: true },
    { doc_no: 'DOC-2607-007', seq: 30, process_no: '30', process_name: '외주 표면처리', process: '외주 표면처리', func: '아노다이징 피막 형성', fail_mode: '피막두께 미달', fail_effect: '내식성 저하', severity: 5, fail_cause: '전해액 농도 저하', occurrence: 2, prevent_ctrl: '협력사 공정조건 승인관리', detect_ctrl: '외주입고검사 피막두께 측정', detection: 4, rpn: 40, char_type: '일반', cp_reflected: true },
    { doc_no: 'DOC-2607-007', seq: 40, process_no: '40', process_name: '검사', process: '검사', func: '최종 외관·치수 확인', fail_mode: '외관 불량 유출', fail_effect: '고객 반품', severity: 7, fail_cause: '검사 조도 부족', occurrence: 2, prevent_ctrl: '검사대 조도 500lux 유지', detect_ctrl: '전수 외관검사', detection: 3, rpn: 42, char_type: '일반', cp_reflected: true },
    { doc_no: 'DOC-2607-007', seq: 50, process_no: '50', process_name: '포장', process: '포장', func: '수량·라벨 포장', fail_mode: '이종품 혼입', fail_effect: '고객 라인 오조립', severity: 4, fail_cause: '라벨 확인 누락', occurrence: 2, prevent_ctrl: '포장 전 품번 라벨 대조', detect_ctrl: '출하검사 수량·라벨 확인', detection: 4, rpn: 32, char_type: '일반', cp_reflected: false },
    // COOLING PIPE (DOC-2607-011)
    { doc_no: 'DOC-2607-011', seq: 10, process_no: '10', process_name: 'PIPE성형', process: 'PIPE성형', func: '벤딩각 90° 성형', fail_mode: '벤딩각 이탈', fail_effect: '차량 장착 간섭', severity: 8, fail_cause: '지그 스토퍼 마모', occurrence: 4, prevent_ctrl: '지그 스토퍼 주간 점검', detect_ctrl: '초·중·종물 각도게이지 측정', detection: 3, rpn: 96, char_type: '특별특성', cp_reflected: true },
    { doc_no: 'DOC-2607-011', seq: 20, process_no: '20', process_name: '용접', process: '용접', func: '브라켓 용접 접합', fail_mode: '용접 비드 불량', fail_effect: '누유·강도 부족', severity: 7, fail_cause: '용접조건(전류) 이탈', occurrence: 3, prevent_ctrl: 'WPS 기준 조건 고정', detect_ctrl: '전수 육안검사', detection: 4, rpn: 84, char_type: '중요특성', cp_reflected: true },
    { doc_no: 'DOC-2607-011', seq: 30, process_no: '30', process_name: '검사', process: '검사', func: '전장 850 확인', fail_mode: '전장 이탈', fail_effect: '체결 불가', severity: 6, fail_cause: '절단 기준면 오차', occurrence: 3, prevent_ctrl: '절단 지그 기준면 관리', detect_ctrl: 'LOT당 1회 버니어 측정', detection: 3, rpn: 54, char_type: '중요특성', cp_reflected: true },
    { doc_no: 'DOC-2607-011', seq: 40, process_no: '40', process_name: '포장', process: '포장', func: '완충 포장', fail_mode: '포장 중 변형', fail_effect: '외관 불량', severity: 3, fail_cause: '완충재 부족', occurrence: 2, prevent_ctrl: '포장 표준 완충재 규정', detect_ctrl: '출하검사 외관 확인', detection: 3, rpn: 18, char_type: '일반', cp_reflected: false },
  ],
  control_plan_items: [
    { doc_no: 'DOC-2607-003', seq: 10, process_no: '10', process_name: 'MCT가공', process: 'MCT가공', char_kind: '제품특성', ctrl_item: '내경 Ø25', char_type: '특별특성', spec_value: '25.0 ±0.02', ctrl_method: '3차원측정', instrument: 'MI-003', equipment: 'MCT-01', inspect_cycle: '초·중·종물', inspect_qty: '3ea', sample_size: '3', owner: '최품질', reaction_plan: '설비정지 후 보고', fmea_ref: '내경 치수 초과' },
    { doc_no: 'DOC-2607-003', seq: 20, process_no: '10', process_name: 'MCT가공', process: 'MCT가공', char_kind: '제품특성', ctrl_item: '전장 120', char_type: '중요특성', spec_value: '120.0 ±0.05', ctrl_method: '3차원측정', instrument: 'MI-003', equipment: 'MCT-01', inspect_cycle: '초·중·종물', inspect_qty: '3ea', sample_size: '3', owner: '최품질', reaction_plan: '전수선별', fmea_ref: '전장 미달' },
    { doc_no: 'DOC-2607-003', seq: 30, process_no: '10', process_name: 'MCT가공', process: 'MCT가공', char_kind: '공정특성', ctrl_item: '주축 회전수', char_type: '일반', spec_value: '1,200 ±50 rpm', ctrl_method: '설비 모니터링', instrument: '', equipment: 'MCT-01', inspect_cycle: '작업시작 시', inspect_qty: '1회', owner: '박생산', reaction_plan: '조건 재설정' },
    { doc_no: 'DOC-2607-003', seq: 40, process_no: '30', process_name: 'CNC가공', process: 'CNC가공', char_kind: '제품특성', ctrl_item: '외경 표면조도', char_type: '일반', spec_value: 'Ra 1.6 이하', ctrl_method: '육안·조도계', instrument: '', equipment: 'CNC-01', inspect_cycle: '1회/LOT', inspect_qty: '2ea', sample_size: '2', owner: '최품질', reaction_plan: '재작업', fmea_ref: '표면 거칠기 불량' },
    // CNC 브라켓 (DOC-2607-008) — PFMEA 고위험·특별특성 전량 반영
    { doc_no: 'DOC-2607-008', seq: 10, process_no: '10', process_name: 'CNC가공', process: 'CNC가공', char_kind: '제품특성', ctrl_item: '외경 Ø95', char_type: '특별특성', spec_value: '95.0 ±0.03', ctrl_method: '마이크로미터 측정', instrument: 'MI-002', equipment: 'CNC-01', inspect_cycle: '초·중·종물', inspect_qty: '3ea', sample_size: '3', owner: '최품질', reaction_plan: '설비정지 후 보고', fmea_ref: '외경 치수 초과' },
    { doc_no: 'DOC-2607-008', seq: 20, process_no: '10', process_name: 'CNC가공', process: 'CNC가공', char_kind: '공정특성', ctrl_item: '절삭유 농도', char_type: '일반', spec_value: '5~8 %', ctrl_method: '굴절계 측정', instrument: '', equipment: 'CNC-01', inspect_cycle: '작업시작 시', inspect_qty: '1회', owner: '박생산', reaction_plan: '조건 재설정' },
    { doc_no: 'DOC-2607-008', seq: 30, process_no: '20', process_name: 'DRILL', process: 'DRILL', char_kind: '제품특성', ctrl_item: '홀 위치도', char_type: '중요특성', spec_value: '위치도 Ø0.2', ctrl_method: '3차원측정', instrument: 'MI-003', equipment: 'DRL-01', inspect_cycle: '초·중·종물', inspect_qty: '3ea', sample_size: '3', owner: '최품질', reaction_plan: '전수선별', fmea_ref: '홀 위치도 이탈' },
    { doc_no: 'DOC-2607-008', seq: 40, process_no: '30', process_name: '외주 표면처리', process: '외주 표면처리', char_kind: '제품특성', ctrl_item: '피막두께', char_type: '일반', spec_value: '10~15 ㎛', ctrl_method: '피막두께 측정', instrument: 'MI-004', equipment: '', inspect_cycle: '1회/LOT', inspect_qty: '3ea', sample_size: '3', owner: '최품질', reaction_plan: '부적합품 격리', fmea_ref: '피막두께 미달' },
    { doc_no: 'DOC-2607-008', seq: 50, process_no: '40', process_name: '검사', process: '검사', char_kind: '제품특성', ctrl_item: '외관 상태', char_type: '일반', spec_value: '스크래치·타흔 없을 것', ctrl_method: '육안검사(조도 500lux)', instrument: '', equipment: 'CMM-01', inspect_cycle: '전수', inspect_qty: '전수', owner: '최품질', reaction_plan: '부적합 등록', fmea_ref: '외관 불량 유출' },
    // COOLING PIPE (DOC-2607-012)
    { doc_no: 'DOC-2607-012', seq: 10, process_no: '10', process_name: 'PIPE성형', process: 'PIPE성형', char_kind: '제품특성', ctrl_item: '벤딩각', char_type: '특별특성', spec_value: '90° ±0.5', ctrl_method: '각도게이지 측정', instrument: 'MI-001', equipment: 'PIPE-01', inspect_cycle: '초·중·종물', inspect_qty: '3ea', sample_size: '3', owner: '박생산', reaction_plan: '설비정지 후 보고', fmea_ref: '벤딩각 이탈' },
    { doc_no: 'DOC-2607-012', seq: 20, process_no: '10', process_name: 'PIPE성형', process: 'PIPE성형', char_kind: '제품특성', ctrl_item: '외관 흠집', char_type: '일반', spec_value: '흠집·찌그러짐 없을 것', ctrl_method: '육안검사', instrument: '', equipment: 'PIPE-01', inspect_cycle: '전수', inspect_qty: '전수', owner: '박생산', reaction_plan: '부적합 등록' },
    { doc_no: 'DOC-2607-012', seq: 30, process_no: '20', process_name: '용접', process: '용접', char_kind: '제품특성', ctrl_item: '용접부 외관', char_type: '중요특성', spec_value: '기공·언더컷 없을 것', ctrl_method: '전수 육안검사', instrument: '', equipment: 'WELD-01', inspect_cycle: '전수', inspect_qty: '전수', owner: '최품질', reaction_plan: '재작업', fmea_ref: '용접 비드 불량' },
    { doc_no: 'DOC-2607-012', seq: 40, process_no: '30', process_name: '검사', process: '검사', char_kind: '제품특성', ctrl_item: '전장 850', char_type: '중요특성', spec_value: '850.0 ±1.0', ctrl_method: '버니어캘리퍼스 측정', instrument: 'MI-001', equipment: 'CMM-01', inspect_cycle: '1회/LOT', inspect_qty: '3ea', sample_size: '3', owner: '최품질', reaction_plan: '전수선별', fmea_ref: '전장 이탈' },
  ],
  work_std_steps: [
    { doc_no: 'DOC-2607-004', seq: 10, process_no: '10', process_name: 'PIPE성형', step_name: '1. 소재 장착', material_setup: '파이프를 벤딩지그에 삽입하고 스토퍼까지 밀착', equipment_op: '클램프 스위치 ON 후 고정상태 확인', method: '파이프를 벤딩지그에 삽입하고 스토퍼까지 밀착', condition: '클램프압 0.5MPa', tools_used: 'T-004 벤딩지그', quality_check: '스토퍼 밀착 확인', inspect_cycle: '작업시작 시', safety: '클램프 작동부 손 접근 금지 · 보호장갑 착용', caution: '클램프 작동 시 손 주의', reaction: '조건 재설정' },
    { doc_no: 'DOC-2607-004', seq: 20, process_no: '10', process_name: 'PIPE성형', step_name: '2. 벤딩 성형', cp_ref: '벤딩각', material_setup: '', equipment_op: '조건 확인 후 양손 시작버튼 2초 누름', method: '자동 사이클 시작 버튼 2초 누름', condition: '벤딩각 90°±0.5, 속도 30%', tools_used: 'PIPE-01', quality_check: '벤딩각 게이지로 초·중·종물 측정 후 기록', inspect_cycle: '초·중·종물', safety: '성형 중 안전문 개방 금지', caution: '성형 중 접근 금지', reaction: '설비정지 후 보고' },
    { doc_no: 'DOC-2607-004', seq: 30, process_no: '10', process_name: 'PIPE성형', step_name: '3. 외관 확인 및 취출·적치', cp_ref: '외관 흠집', material_setup: '', equipment_op: '사이클 완료 확인 후 클램프 해제', method: '성형품을 취출하여 지정 대차에 적치', condition: '', tools_used: '', quality_check: '외관 흠집·찌그러짐 전수 확인', inspect_cycle: '전수', safety: '낙하 주의 · 안전화 착용', caution: '낙하 주의', reaction: '부적합 등록' },
    { doc_no: 'DOC-2607-005', seq: 10, process_no: '10', process_name: 'MCT가공', step_name: '1. 품번·LOT 확인 및 소재 장착', material_setup: '작업지시 품번 확인 후 AL6061 환봉을 척에 장착, 돌출길이 게이지로 확인', equipment_op: '척킹압 확인 후 도어 클로즈', method: '소재를 척에 장착하고 돌출길이를 게이지로 맞춘다', condition: '척킹압 2.0MPa, 돌출 135mm', tools_used: '돌출게이지', quality_check: '품번·LOT 일치 및 돌출길이 확인', inspect_cycle: '작업시작 시', safety: '척 회전 전 도어 잠금 확인', caution: '척 회전부 접근 금지', reaction: '조건 재설정' },
    { doc_no: 'DOC-2607-005', seq: 20, process_no: '10', process_name: 'MCT가공', step_name: '2. 주축조건 세팅 및 가공', material_setup: '', equipment_op: '프로그램 O1020 호출 후 주축 회전수 1,200rpm 설정, 사이클 스타트', method: '가공 프로그램 실행 후 자동 사이클 가공', condition: '주축 1,200±50rpm, 이송 0.15mm/rev', tools_used: 'T-001 엔드밀', quality_check: '주축 회전수 설정값 확인', inspect_cycle: '작업시작 시', safety: '가공 중 절삭유 비산 주의 · 보안경 착용', caution: '가공 중 도어 개방 금지', reaction: '조건 재설정' },
    { doc_no: 'DOC-2607-005', seq: 30, process_no: '10', process_name: 'MCT가공', step_name: '3. 내경 Ø25 측정', material_setup: '', equipment_op: '가공 완료품 취출 후 측정대 이동', method: '3차원측정기로 내경을 측정하고 검사일지에 기록', condition: '25.0 ±0.02', tools_used: 'MI-003 3차원측정기', quality_check: '초·중·종물 3점 측정 후 기록 (특별특성 ◆)', inspect_cycle: '초·중·종물', safety: '측정품 모서리 버 주의', caution: '측정 전 온도 안정화 20분', reaction: '설비정지 후 보고' },
    { doc_no: 'DOC-2607-005', seq: 40, process_no: '10', process_name: 'MCT가공', step_name: '4. 전장 120 측정', material_setup: '', equipment_op: '', method: '3차원측정기로 전장을 측정하고 검사일지에 기록', condition: '120.0 ±0.05', tools_used: 'MI-003 3차원측정기', quality_check: '초물 1회 측정 후 기록', inspect_cycle: '초물', safety: '', caution: '기준면 이물 제거 후 측정', reaction: '전수선별' },
    // CNC 브라켓 전공정 작업표준서 (DOC-2607-009) — 관리계획서 5개 항목 전량 반영
    { doc_no: 'DOC-2607-009', seq: 10, process_no: '10', process_name: 'CNC가공', step_name: '1. 소재 장착 및 절삭유 확인', cp_ref: '절삭유 농도', material_setup: '작업지시 품번 확인 후 AL6063 압출바를 척에 장착', equipment_op: '굴절계로 절삭유 농도를 확인하고 부족 시 보충', method: '작업 시작 전 절삭유 농도를 측정하고 소재를 장착한다', condition: '절삭유 5~8%, 척킹압 1.8MPa', tools_used: '굴절계', quality_check: '절삭유 농도 5~8% 확인 후 기록', inspect_cycle: '작업시작 시', safety: '척 회전 전 도어 잠금 확인', caution: '농도 미달 시 공구 마모 급증', reaction: '조건 재설정' },
    { doc_no: 'DOC-2607-009', seq: 20, process_no: '10', process_name: 'CNC가공', step_name: '2. 외경 Ø95 가공 및 측정', cp_ref: '외경 Ø95', material_setup: '', equipment_op: '프로그램 O2010 호출 후 사이클 스타트', method: '가공 후 마이크로미터로 외경을 측정하고 검사일지에 기록', condition: '95.0 ±0.03 (특별특성 ◆)', tools_used: 'MI-002 마이크로미터', quality_check: '초·중·종물 3점 측정 후 기록 (특별특성 ◆)', inspect_cycle: '초·중·종물', safety: '가공 중 도어 개방 금지 · 보안경 착용', caution: '인서트 300개 가공 시 교체', reaction: '설비정지 후 보고' },
    { doc_no: 'DOC-2607-009', seq: 30, process_no: '20', process_name: 'DRILL', step_name: '3. 홀 Ø8 가공 및 위치도 측정', cp_ref: '홀 위치도', material_setup: '전용지그에 반제품을 장착하고 클램프 고정', equipment_op: '지그 클램프 유격 확인 후 드릴 사이클 실행', method: '홀 가공 후 3차원측정기로 위치도를 측정한다', condition: '위치도 Ø0.2, 회전수 1,800rpm', tools_used: 'MI-003 3차원측정기', quality_check: '초·중·종물 3점 위치도 측정 후 기록', inspect_cycle: '초·중·종물', safety: '칩 제거 시 반드시 설비 정지', caution: '지그 유격 발생 시 즉시 보고', reaction: '전수선별' },
    { doc_no: 'DOC-2607-009', seq: 40, process_no: '30', process_name: '외주 표면처리', step_name: '4. 외주 입고품 피막두께 확인', cp_ref: '피막두께', material_setup: '외주 입고품을 검사대에 정렬', equipment_op: '', method: '피막두께 측정기로 LOT당 3개소를 측정한다', condition: '10~15 ㎛', tools_used: 'MI-004 하이트게이지', quality_check: 'LOT당 3ea 피막두께 측정 후 기록', inspect_cycle: '1회/LOT', safety: '처리품 모서리 날카로움 주의', caution: '측정 전 표면 이물 제거', reaction: '부적합품 격리' },
    { doc_no: 'DOC-2607-009', seq: 50, process_no: '40', process_name: '검사', step_name: '5. 최종 외관 전수검사', cp_ref: '외관 상태', material_setup: '', equipment_op: '검사대 조도 500lux 확인', method: '조도 500lux 검사대에서 스크래치·타흔을 전수 확인한다', condition: '스크래치·타흔 없을 것', tools_used: '', quality_check: '전수 외관검사 후 합격품만 포장 이송', inspect_cycle: '전수', safety: '장시간 검사 시 30분마다 휴식', caution: '의심품은 반드시 재확인', reaction: '부적합 등록' },
  ],
  // Gauge R&R 관리대장 / 계획
  grr_registers: [
