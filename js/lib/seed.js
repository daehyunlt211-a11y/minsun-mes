...
export const SEED = {
  ...
  work_std_steps: [
    ...
    { doc_no: 'DOC-2607-004', seq: 20, process_no: '20', process_name: 'PIPE성형', step_name: '2. 벤딩 성형', material_setup: '', equipment_op: '조건 확인 후 양손 시작버튼 2초 누름', method: '자동 사이클 시작 버튼 2초 누름', condition: '벤딩각 90°±0.5, 속도 30%', tools_used: 'PIPE-01', quality_check: '벤딩각 게이지로 초·중·종물 측정 후 기록', inspect_cycle: '초·중·종물', safety: '성형 중 안전문 개방 금지', caution: '성형 중 접근 금지', reaction: '설비정지 후 보고' },
    { doc_no: 'DOC-2607-004', seq: 30, process_no: '30', process_name: 'PIPE성형', step_name: '3. 취출·적치', material_setup: '', equipment_op: '사이클 완료 확인 후 클램프 해제', method: '성형품을 취출하여 지정 대차에 적치', condition: '', tools_used: '', quality_check: '외관 흠집·찌그러짐 전수 확인', inspect_cycle: '전수', safety: '낙하 주의 · 안전화 착용', caution: '낙하 주의', reaction: '부적합 등록' },
