...
export const productionPlans = createCrudPage({
  ...
  fields: [
    ...
    { key: 'item_code', label: '품목 (계획생산은 직접 선택 · 완제품·반제품)', required: true, ref: { table: 'items', value: 'code', filter: (r) => ['완제품', '반제품'].includes(r.item_type), label: (r) => `${r.code} · ${r.name} [${r.item_type || ''}]`, fill: { item_name: 'name' } }, placeholder: '품목 선택' },
