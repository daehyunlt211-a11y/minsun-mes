...
const SCREENS = [
  ...
  S({ id: 'pop', title: '작업 POP', group: '작업 POP', path: '/pop', type: 'pop',
    ...
    feats: [
      ...
      ['세팅품 측정 인터록', '작업 시작 시 대표 불량 4매 확인 체크 필수 → 세팅품(초물) 측정값이 검사규격 대비 전 항목 OK여야 [진행] 전환. NG면 세팅 상태로 잠겨 종료 불가 (생산 회의 4.1·4.2·4.3)'],
      ['초·중·종물 측정', '세팅품 필수, 중·종물 선택 측정. 검사규격(공정검사)의 기준값·상·하한으로 OK/NG 자동판정, 최종 입력값이 최종 측정값'],
      ['불량 폐기/재작업/특채 구분', '종료 시 불량을 폐기·재작업·특채로 구분 입력. 폐기·재작업은 이월 제외(폐기분만 생산수량 차감), 재작업은 재작업 공정 자동 추가, 특채는 양품 이월. 원소재 불량은 재고만 차감 (생산 회의 4.7·4.8)'],
